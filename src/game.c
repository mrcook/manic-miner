...
static void MOVEWILLY_8();
static void MOVEWILLY_9();
...
void CRUMBLE(uint16_t addr) {
    ...
    memcpy(&speccy.memory[build_address((uint8_t) (msb + 2), lsb)], cavern.BACKGROUND.sprite,
           sizeof(cavern.BACKGROUND.sprite));
