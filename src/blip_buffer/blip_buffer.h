...
public:
	...
	// Read at most 'max_samples' out of blipBuffer into 'dest', removing them from from
	// the blipBuffer. Returns number of samples actually read and removed. If stereo is
	// true, increments 'dest' one extra time after writing each sample, to allow
	// easy interleving of two channels into a stereo output blipBuffer.
...
// Additional optional features
	...
	// Length of blipBuffer, in milliseconds
	int length() const;
	...
	// Remove all available samples and clear blipBuffer to silence. If 'entire_buffer' is
	// false, just clears out any samples waiting rather than the entire blipBuffer.
...
// Experimental features
	...
	// Mix 'count' samples from 'blipBuffer' into blipBuffer.
	void mix_samples( blip_sample_t const* buf, long count );
	
	// Count number of clocks needed until 'count' samples will be available.
	// If blipBuffer can't even hold 'count' samples, returns number of clocks until
	// blipBuffer becomes full.
...
// but reduce maximum blipBuffer size.
...
// Low-level interface
	...
	// Add an amplitude transition of specified delta, optionally into specified blipBuffer
...
class Blip_Reader {
public:
	// Begin reading samples from blipBuffer. Returns value to pass to next() (can
	...
	// End reading samples from blipBuffer. The number of samples read must now be removed
		...
		int delta, Blip_Buffer* blip_buf ) const
{
	...
	// need for a longer blipBuffer as set by set_sample_rate().
